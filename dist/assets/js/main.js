...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor_terminal_terminal__ = __webpack_require__(12);
...
var terminal = new __WEBPACK_IMPORTED_MODULE_0__vendor_terminal_terminal___default.a('terminal', {}, {
  execute: function execute(cmd, args) {
    ...
    if ('clear' === request) {
      ...
      return __WEBPACK_IMPORTED_MODULE_1__info__["a" /* default */].getProject(parseInt(request.replace('project/', '')));
    } else {
